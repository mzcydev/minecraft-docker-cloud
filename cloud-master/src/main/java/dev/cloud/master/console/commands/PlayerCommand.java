...
public class PlayerCommand implements Command {
    ...
    @Override public String getDescription() { return "View online players."; }
    @Override public String getUsage()       { return "player <list|info> [name]"; }
    ...
    public void execute(CommandSender sender, String[] args) {
        ...
        switch (args[0].toLowerCase()) {
            ...
            case "info" -> {
                if (args.length < 2) { sender.sendMessage("Usage: player info <name>"); return; }
